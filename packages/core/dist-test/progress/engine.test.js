...
describe('recordQuizAttempt', () => {
    const allCorrect = () => module01.reps[0].quiz.map((q) => ({
        questionId: q.id,
...
describe('computeStreak', () => {
    ...
    test('longest is remembered after a break', () => {
        const s = computeStreak(['2026-08-01', '2026-08-02', '2026-08-03', '2026-08-04', '2026-08-11', '2026-08-12'], at('2026-08-12'));
